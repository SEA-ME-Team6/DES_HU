...
if(CMAKE_INSTALL_COMPONENT STREQUAL "Unspecified" OR NOT CMAKE_INSTALL_COMPONENT)
  if(EXISTS "$ENV{DESTDIR}/usr/bin/DES3/rpm_sender/rpm_sender" AND
    ...
    file(RPATH_CHECK
         FILE "$ENV{DESTDIR}/usr/bin/DES3/rpm_sender/rpm_sender"
         RPATH "")
  endif()
  list(APPEND CMAKE_ABSOLUTE_DESTINATION_FILES
   "/usr/bin/DES3/rpm_sender/rpm_sender")
  ...
  if(EXISTS "$ENV{DESTDIR}/usr/bin/DES3/rpm_sender/rpm_sender" AND
    ...
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}/usr/bin/DES3/rpm_sender/rpm_sender")
    endif()
  endif()
endif()
